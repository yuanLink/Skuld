...
void write()
{
	...
	Ptr<Stream> cop(CompressedStream::CreateDeflateStream(mem, CompressionMode_Compress));
...
void read()
{
	...
	Ptr<Stream> cop(CompressedStream::CreateDeflateStream(mem, CompressionMode_Decompress));
	char test[110];
